...
// templates/policies/addon_permission_policy.json
...
var _templatesPoliciesAddon_permission_policyJson = []byte(`{
  "Version": "2012-10-17",
  "Statement": [
    {
      "Effect": "Allow",
...
func templatesPoliciesAddon_permission_policyJsonBytes() ([]byte, error) {
	return _templatesPoliciesAddon_permission_policyJson, nil
}

func templatesPoliciesAddon_permission_policyJson() (*asset, error) {
	bytes, err := templatesPoliciesAddon_permission_policyJsonBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "templates/policies/addon_permission_policy.json", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"templates/policies/addon_permission_policy.json":                                                           templatesPoliciesAddon_permission_policyJson,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"templates": &bintree{nil, map[string]*bintree{
		...
		"policies": &bintree{nil, map[string]*bintree{
			"addon_permission_policy.json":                                                           &bintree{templatesPoliciesAddon_permission_policyJson, map[string]*bintree{}},
